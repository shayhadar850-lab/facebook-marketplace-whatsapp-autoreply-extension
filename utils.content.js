(function () {
  ...
  function normalizePhoneForWaMe(phone) {
  ...
  function buildReply(settings, threadKey) {
  ...
  function buildThreadKey(threadText) {
  ...
  function canReplyToThread({ settings, threadText, handledThreads }) {
